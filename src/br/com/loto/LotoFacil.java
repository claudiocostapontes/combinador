...
public class LotoFacil<T> {
    private final int cnt;
    private final T[] items;
    private final List<int[]> somatorios;

    public LotoFacil(int cnt, T[] items) {
        this.cnt = cnt;
        this.items = items;
    ...
    public static Integer[] gerarApostaComEstatisticas(int tamanhoAposta, int quantidadeMaisFrequentes, int quantidadeMenosFrequentes, long seed) {
    ...
    public static void main(String[] args) {
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            for (int i = 0; i < quantidadeApostas; i++) {
                ...
                Integer[] aposta = gerarApostaComEstatisticas(tamanhoAposta, 0, 0, seed);
